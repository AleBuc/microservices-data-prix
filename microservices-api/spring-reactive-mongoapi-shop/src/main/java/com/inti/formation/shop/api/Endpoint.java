...
public class Endpoint {
    ...
    @GetMapping
    @RequestMapping(value = "/stockInitByIdproduct")
    public Flux<StockInit> getIdproduct(@RequestParam(required = true, name = "idproduct") int idproduct ) {
    ...
    @GetMapping
    @RequestMapping(value = "/stockInitByMagasin")
    public Flux<StockInit> getMagasin(@RequestParam(required = true, name = "magasin") String magasin ) {
    ...
    @GetMapping
    @RequestMapping(value = "/stockInitByQuantity")
    public Flux<StockInit> getQuantite(@RequestParam(required = true, name = "quantite") int quantite ) {
    ...
    @GetMapping
    @RequestMapping(value = "/produitByLibelle")
    public Flux<Produit> getLibelle(@RequestParam(required = true, name = "libelle") String libelle ) {
    ...
    @GetMapping
    @RequestMapping(value = "/produitByOrigine")
    public Flux<Produit> getOrigine(@RequestParam(required = true, name = "origine") String origine ) {
